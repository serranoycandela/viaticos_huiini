...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.input_carpeta = QPushButton(self.splitter)
        self.input_carpeta.setObjectName(u"input_carpeta")
        self.input_carpeta.setEnabled(True)
        sizePolicy3 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Preferred)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(1)
        sizePolicy3.setHeightForWidth(self.input_carpeta.sizePolicy().hasHeightForWidth())
        self.input_carpeta.setSizePolicy(sizePolicy3)
        self.input_carpeta.setMinimumSize(QSize(0, 30))
        self.input_carpeta.setMaximumSize(QSize(16777215, 30))
        self.splitter.addWidget(self.input_carpeta)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.input_carpeta.setText(QCoreApplication.translate("MainWindow", u"Carpeta(s) de Viaje", None))
